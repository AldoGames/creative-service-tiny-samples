...
{
    public class UTinyAnimatedTree 
    {
        public class Element
        {
            ...
            {
                return new Element(name, tooltip, included, false, null);
            }

            public static Element MakeLeaf(string name, string tooltip, bool included, Action onClick)
            {
                return new Element(name, tooltip, included, false, onClick);
            }

            public static Element MakeWarning(string warning)
            {
                return new Element(warning, "", true, true, null);
            }
            ...
            private Element(string name, string tooltip, bool included = true, bool warning = false, Action onClick = null)
            {
                m_Name = name;
                m_Tooltip = tooltip;
                m_OnClick = onClick;
