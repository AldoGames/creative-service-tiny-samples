...
namespace Unity.Tiny
{
    ...
    /// </summary>
    public class UTinyToolbar : IDrawable
    {
        ...
        public interface IToolbarItem : IDrawable
        {
            Alignment Alignment { get; }
        }

        public class Popup : IToolbarItem
        {
        ...
        public class FilterPopup : PopupWindowContent
        {
        ...
        public class Search : IToolbarItem
        {
        ...
        public class DropDown : IToolbarItem
        {
            public Alignment Alignment { get; set; }
            public string[] Items;
        ...
        public class Menu : IToolbarItem
        {
            public class Item
            {
            ...
            public bool DrawLayout()
            {
                using (var scope = new EditorGUILayout.HorizontalScope(GUILayout.Width(75)))
                {
                    ...
                    foreach (var item in Items)
                    {
                        if (null == item.Validation || item.Validation.Invoke())
                        {
        ...
        public class Button : IToolbarItem
        {
            public Alignment Alignment { get; set; }
            ...
            public bool DrawLayout()
            {
                using (new GUIEnabledScope(null == Validation || Validation.Invoke()))
                {
        ...
        public class Toggle : IToolbarItem
        {
            public Alignment Alignment { get; set; }
            public Texture2D Icon { get; set; }
            public string Tooltip { get; set; }
