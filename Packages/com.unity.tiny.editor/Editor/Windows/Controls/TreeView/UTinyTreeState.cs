...
{
    [Serializable]
    public class UTinyTreeState : ISerializationCallbackReceiver
    {
        ...
        private readonly Dictionary<UTinyId, int> m_InstanceIds = new Dictionary<UTinyId, int>();
        ...
        public void OnAfterDeserialize()
        {
            ...
            {
                m_InstanceIds.Add(new UTinyId(m_InstanceIdKeys[i]), m_InstanceIdValues[i]);
            }
